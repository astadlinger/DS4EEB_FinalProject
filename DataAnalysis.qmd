...
g1 <- ggplot(data = lynx_open, aes(x = Habitat, y = Seeds_predated_total)) +
  geom_col()
```
...
g2 <- ggplot(data = lynx_rock, aes(x = Habitat, y = Seeds_predated_total)) +
  geom_col()
```
...
g3 <- ggplot(data = lynx_shrub, aes(x = Habitat, y = Seeds_predated_total)) +
  geom_col()
```
...
g4 <- ggplot(data = lynx_open, aes(x = Habitat, y = Seeds_predated_total)) +
  geom_col()
```
...
g5 <- ggplot(data = noLynx_rock, aes(x = Habitat, y = Seeds_predated_total)) +
  geom_col()
```
...
g6 <- ggplot(data = noLynx_shrub, aes(x = Habitat, y = Seeds_predated_total)) +
  geom_col()
```

```{r}
#panel all 6 graphs together
(g1 / g2 / g3) + (g4 / g5 / g6)
```
